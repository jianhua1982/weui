...
if (!window.jQuery) {
    var jQuery = Zepto;
    (function (a) {
        ["width", "height"].forEach(function (j) {
            a.fn[j] = function (c) {
                var q, b = document.body, E = document.documentElement, t = j.replace(/./, function (a) {
                    return a[0].toUpperCase()
                });
                return void 0 === c ? this[0] == window ? E["client" + t] : this[0] == document ? Math.max(b["scroll" + t], b["offset" + t], E["client" + t], E["scroll" + t], E["offset" + t]) : (q = this.offset()) && q[j] : this.each(function () {
                    a(this).css(j, c)
                })
            }
        });
        ["width", "height"].forEach(function (j) {
            var c = j.replace(/./, function (a) {
                return a[0].toUpperCase()
            });
            a.fn["outer" + c] = function (a) {
                ...
                if (b) {
                    var E = b[0]["offset" + c];
                    ({width: ["left", "right"], height: ["top", "bottom"]})[j].forEach(function (c) {
                        a && (E += parseInt(b.css("margin-" + c), 10))
                    });
                    return E
                }
                return null
        ...
        ["width", "height"].forEach(function (j) {
            ...
            a.fn["inner" + c] = function () {
                ...
                var b = a[0]["offset" + c];
                ({width: ["left", "right"], height: ["top", "bottom"]})[j].forEach(function (c) {
                    b -= parseInt(a.css("border-" +
                        c + "-width"), 10)
                });
                return b
            }
        });
        ["Left", "Top"].forEach(function (j, c) {
            function q(a) {
            ...
            a.fn[b] = function (j) {
                var t, d;
                if (void 0 === j)return t = this[0], !t ? null : (d = q(t)) ? "pageXOffset"in d ? d[c ? "pageYOffset" : "pageXOffset"] : d.document.documentElement[b] || d.document.body[b] : t[b];
                this.each(function () {
                    if (d = q(this)) {
                        var t = !c ? j : a(d).scrollLeft(), I = c ? j : a(d).scrollTop();
                        d.scrollTo(t, I)
                    } else this[b] = j
                })
            }
        });
        a.fn.prevUntil = function (j) {
            for (var c = this, q = []; c.length && !a(c).filter(j).length;)q.push(c[0]), c = c.prev();
            return a(q)
        };
        a.fn.nextUntil = function (j) {
            for (var c = this, q = []; c.length && !c.filter(j).length;)q.push(c[0]), c = c.next();
            return a(q)
        };
        a._extend = a.extend;
        a.extend = function () {
